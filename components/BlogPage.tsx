          ...
          <div className="flex space-x-2 min-w-max">
            {categories.map((cat) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 whitespace-nowrap ${activeCategory === cat
              ...
              {filteredPosts.map((post, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`group cursor-pointer relative bg-white dark:bg-edluar-surface rounded-2xl overflow-hidden border border-edluar-pale/50 dark:border-edluar-moss/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 flex flex-col ${isBigCard ? 'lg:col-span-2 lg:row-span-2 min-h-[500px]' : 'col-span-1 min-h-[400px]'
                      }`}
                  >
                    {/* Image Container */}
