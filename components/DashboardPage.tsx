         ...
         <header className="h-20 flex items-center justify-between px-8 bg-edluar-cream dark:bg-edluar-deep sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-4">
               <div className="flex items-center space-x-2">
                  <span className="text-sm font-medium text-edluar-dark dark:text-edluar-cream">Emily Rostova</span>
                  <div className="w-8 h-8 rounded-full bg-edluar-moss text-white flex items-center justify-center font-bold text-xs border-2 border-white dark:border-edluar-deep">ER</div>
               </div>
            </div>
         </header>
